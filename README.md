...
For prerequisites and detailed build instructions please read the [Installation Instructions](https://github.com/promethiumchain/promethium/wiki/Building-Ethereum) on the wiki.
 ...
 * Start up `geth`'s built-in interactive [JavaScript console](https://github.com/promethiumchain/promethium/wiki/JavaScript-Console),
   (via the trailing `console` subcommand) through which you can invoke all official [`web3` methods](https://github.com/ethereum/wiki/wiki/JavaScript-API)
   as well as `geth`'s own [management APIs](https://github.com/promethiumchain/promethium/wiki/Management-APIs).
...
and [`geth` specific APIs](https://github.com/promethiumchain/promethium/wiki/Management-APIs)).
