 ...
 * @author Gary Rong<garyrong@promethium.org>, Martin Swende <martin.swende@promethium.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the promethium.
    uint sectionSize;
