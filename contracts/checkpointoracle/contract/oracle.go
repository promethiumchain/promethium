...
// DeployCheckpointOracle deploys a new Promethium contract, binding an instance of CheckpointOracle to it.
...
// CheckpointOracle is an auto generated Go binding around an Promethium contract.
...
// CheckpointOracleCaller is an auto generated read-only Go binding around an Promethium contract.
type CheckpointOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleTransactor is an auto generated write-only Go binding around an Promethium contract.
type CheckpointOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleFilterer is an auto generated log filtering Go binding around an Promethium contract events.
type CheckpointOracleFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// CheckpointOracleSession is an auto generated Go binding around an Promethium contract,
...
// CheckpointOracleCallerSession is an auto generated read-only Go binding around an Promethium contract,
...
// CheckpointOracleTransactorSession is an auto generated write-only Go binding around an Promethium contract,
...
// CheckpointOracleRaw is an auto generated low-level Go binding around an Promethium contract.
type CheckpointOracleRaw struct {
	Contract *CheckpointOracle // Generic contract binding to access the raw methods on
}

// CheckpointOracleCallerRaw is an auto generated low-level read-only Go binding around an Promethium contract.
...
// CheckpointOracleTransactorRaw is an auto generated low-level write-only Go binding around an Promethium contract.
