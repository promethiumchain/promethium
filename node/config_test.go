...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "promethium.ipc", false, filepath.Join(os.TempDir(), "promethium.ipc")},
		{"data", "promethium.ipc", false, "data/promethium.ipc"},
		{"data", "./promethium.ipc", false, "./promethium.ipc"},
		{"data", "/promethium.ipc", false, "/promethium.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "promethium.ipc", true, `\\.\pipe\promethium.ipc`},
		{"data", "promethium.ipc", true, `\\.\pipe\promethium.ipc`},
		{"data", `\\.\pipe\promethium.ipc`, true, `\\.\pipe\promethium.ipc`},
	}
