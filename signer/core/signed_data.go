// Copyright 2019 The promethium Authors
...
func (api *SignerAPI) determineSignatureFormat(ctx context.Context, contentType string, addr common.MixedcaseAddress, data interface{}) (*SignDataRequest, bool, error) {
	var (
		req          *SignDataRequest
		useEthereumV = true // Default to use V = 27 or 28, the legacy Promethium format
	)
	...
	case ApplicationClique.Mime:
		// Clique is the Promethium PoA standard
	...
	default: // also case TextPlain.Mime:
		// Calculates an Promethium ECDSA signature for:
		// hash = keccak256("\x19${byteVersion}Promethium Signed Message:\n${message length}${message}")
