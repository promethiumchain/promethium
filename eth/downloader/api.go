...
// Syncing provides information when this nodes starts synchronising with the Promethium network and when it's finished.
...
type SyncingResult struct {
	...
	Status  promethium.SyncProgress `json:"status"`
}
