...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Promethium
...
func (eth *Promethium) startBloomHandlers(sectionSize uint64) {
...
// for the Promethium header bloom filters, permitting blazing fast filtering.
