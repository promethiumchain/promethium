...
// PublicEthereumAPI provides an API to access Promethium full node-related
// information.
type PublicEthereumAPI struct {
	e *Promethium
}

// NewPublicEthereumAPI creates a new Promethium protocol API for full nodes.
func NewPublicEthereumAPI(e *Promethium) *PublicEthereumAPI {
...
// ChainId is the EIP-155 replay-protection chain id for the current promethium chain config.
...
func NewPublicMinerAPI(e *Promethium) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Promethium) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of Promethium full node-related APIs
...
// admin methods of the Promethium service.
func NewPrivateAdminAPI(eth *Promethium) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Promethium full node APIs exposed
...
// related public debug methods of the Promethium service.
func NewPublicDebugAPI(eth *Promethium) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Promethium full node APIs exposed over
...
// private debug methods of the Promethium service.
func NewPrivateDebugAPI(eth *Promethium) *PrivateDebugAPI {
