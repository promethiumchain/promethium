...
// information related to the Promethium protocol such als blocks, transactions and logs.
...
//
// https://github.com/promethium/wiki/wiki/JSON-RPC#eth_newpendingtransactionfilter
...
//
// https://github.com/promethium/wiki/wiki/JSON-RPC#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(promethium.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as promethium.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria promethium.FilterQuery
...
//
// https://github.com/promethium/wiki/wiki/JSON-RPC#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(promethium.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/promethium/wiki/wiki/JSON-RPC#eth_getlogs
...
//
// https://github.com/promethium/wiki/wiki/JSON-RPC#eth_uninstallfilter
...
//
// https://github.com/promethium/wiki/wiki/JSON-RPC#eth_getfilterlogs
...
//
// https://github.com/promethium/wiki/wiki/JSON-RPC#eth_getfilterchanges
