...
// MainnetGenesis returns the JSON spec to use for the main Promethium network. It
// is actually empty since that defaults to the hard coded binary genesis block.
func MainnetGenesis() string {
	return ""
}

// TestnetGenesis returns the JSON spec to use for the Promethium test network.
