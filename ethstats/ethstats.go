...
// Service implements an Promethium netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Promethium      // Full Promethium service if monitoring a full node
	les    *les.LightEthereum // Light Promethium service if monitoring a light node
...
func New(url string, ethServ *eth.Promethium, lesServ *les.LightEthereum) (*Service, error) {
