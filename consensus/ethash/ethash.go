...
// all blocks' seal as valid, though they still have to conform to the Promethium
// consensus rules.
...
// still have to conform to the Promethium consensus rules.
...
// they still have to conform to the Promethium consensus rules.
