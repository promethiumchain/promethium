...
// mapped from textual names used in the tests below to actual Promethium private
...
// address retrieves the Promethium address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Promethium address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/promethiumchain/promethium/issues/17593). Whilst this
