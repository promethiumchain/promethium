...
The dashboard is a data visualizer integrated into promethium, intended to collect and visualize useful information of an Promethium node. It consists of two parts:
...
As the dashboard depends on certain NPM packages (which are not included in the `promethium` repo), these need to be installed first:
...
```
$ promethium --dashboard --vmodule=dashboard=5
