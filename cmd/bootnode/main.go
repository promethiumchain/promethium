...
// bootnode runs a bootstrap node for the Promethium Discovery Protocol.
package main
...
import (
	...
	"github.com/promethiumchain/promethium/p2p/discover"
...
func main() {
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "promethium discovery")
		}
