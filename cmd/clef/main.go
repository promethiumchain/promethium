...
import (
	...
	"github.com/promethiumchain/promethium/signer/fourbyte"
	"github.com/promethiumchain/promethium/signer/rules"
	"github.com/promethiumchain/promethium/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Promethium account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
