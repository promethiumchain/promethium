...
type wizard struct {
	...
	services map[string][]string   // Promethium services known to be running on servers
...
// converts it to an Promethium address. If an empty line is entered, the default
// value is returned.
