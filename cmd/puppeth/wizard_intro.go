...
// setting up a new or managing an existing Promethium private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Promethium private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Promethium network down to  |")
	...
	log.Info("Administering Promethium network", "name", w.network)
