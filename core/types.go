...
type Prefetcher interface {
	// Prefetch processes the state changes according to the Promethium rules by running
...
type Processor interface {
	// Process processes the state changes according to the Promethium rules by running
