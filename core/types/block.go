...
// Package types contains data types related to Promethium consensus.
package types
...
// DecodeRLP decodes the Promethium
...
// EncodeRLP serializes b into the Promethium RLP block format.
