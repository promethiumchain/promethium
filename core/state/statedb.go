...
// Package state provides a caching layer atop the Promethium state trie.
package state
...
// StateDBs within the promethium protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/promethiumchain/promethium/pull/16485#issuecomment-380438527),
