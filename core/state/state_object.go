...
// stateObject represents an Promethium account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of promethium address of the account
	data     Account
	db       *StateDB
...
// Account is the Promethium consensus representation of accounts.
