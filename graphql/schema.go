...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Promethium address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Promethium account at a particular block.
    type Account {
    ...
    # Log is an Promethium event log.
    type Log {
    ...
    # Transaction is an Promethium transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Promethium account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Promethium account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Promethium block by number or by hash. If neither is
