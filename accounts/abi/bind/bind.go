...
// Package bind generates Promethium contract Go bindings.
//
// Detailed usage document and tutorial available on the promethium Wiki page:
// https://github.com/promethiumchain/promethium/wiki/Native-DApps:-Go-bindings-to-Promethium-contracts
package bind
