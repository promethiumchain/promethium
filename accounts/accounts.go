...
// Package accounts implements high level Promethium account management.
package accounts
...
// Account represents an Promethium account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Promethium account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(bases []DerivationPath, chain promethium.ChainStateReader)
	...
	// by the Promethium prefix scheme
	// It looks up the account specified either solely via its address contained within,
	// or optionally with the aid of any location metadata from the embedded URL field.
	//
	// If the wallet requires additional authentication to sign the request (e.g.
