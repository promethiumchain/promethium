...
// source: messages-promethium.proto
...
//*
// Request: Ask device for Promethium address corresponding to address_n path
// @start
...
//*
// Response: Contains an Promethium address derived from device private seed
// @end
...
func init() {
	proto.RegisterType((*EthereumGetPublicKey)(nil), "hw.trezor.messages.promethium.EthereumGetPublicKey")
	proto.RegisterType((*EthereumPublicKey)(nil), "hw.trezor.messages.promethium.EthereumPublicKey")
	proto.RegisterType((*EthereumGetAddress)(nil), "hw.trezor.messages.promethium.EthereumGetAddress")
	proto.RegisterType((*EthereumAddress)(nil), "hw.trezor.messages.promethium.EthereumAddress")
	proto.RegisterType((*EthereumSignTx)(nil), "hw.trezor.messages.promethium.EthereumSignTx")
	proto.RegisterType((*EthereumTxRequest)(nil), "hw.trezor.messages.promethium.EthereumTxRequest")
	proto.RegisterType((*EthereumTxAck)(nil), "hw.trezor.messages.promethium.EthereumTxAck")
	proto.RegisterType((*EthereumSignMessage)(nil), "hw.trezor.messages.promethium.EthereumSignMessage")
	proto.RegisterType((*EthereumMessageSignature)(nil), "hw.trezor.messages.promethium.EthereumMessageSignature")
	proto.RegisterType((*EthereumVerifyMessage)(nil), "hw.trezor.messages.promethium.EthereumVerifyMessage")
}

func init() { proto.RegisterFile("messages-promethium.proto", fileDescriptor_cb33f46ba915f15c) }
