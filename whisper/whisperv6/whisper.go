...
// Whisper represents a dark communication interface through the Promethium
...
// New creates a Whisper client ready to communicate through the Promethium P2P network.
