// Copyright 2015 The promethium Authors
...
import (
	...
	"github.com/promethiumchain/promethium/accounts/scwallet"
...
// PublicEthereumAPI provides an API to access Promethium related information.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicEthereumAPI struct {
	b Backend
}

// NewPublicEthereumAPI creates a new Promethium protocol API.
...
// ProtocolVersion returns the current Promethium protocol version this node supports
...
// Sign calculates an Promethium ECDSA signature for:
...
//
// https://github.com/promethiumchain/promethium/wiki/Management-APIs#personal_sign
...
//
// https://github.com/promethiumchain/promethium/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != 65 {
		return common.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid Promethium signature (V is not 27 or 28)")
	}
...
// Unpair deletes a pairing between wallet and promethium.
...
// PublicBlockChainAPI provides an API to access the Promethium blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
type PublicBlockChainAPI struct {
	b Backend
}

// NewPublicBlockChainAPI creates a new Promethium blockchain API.
...
//
// https://github.com/promethium/wiki/wiki/JSON-RPC#eth_sign
...
// PublicDebugAPI is the collection of Promethium APIs exposed over the public
// debugging endpoint.
...
// PrivateDebugAPI is the collection of Promethium APIs exposed over the private
// debugging endpoint.
...
// Version returns the current promethium protocol version.
