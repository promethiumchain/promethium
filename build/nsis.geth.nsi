...
# 1. install promethium for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for promethium
# 5. create promethium, attach and uninstall start menu entries
...
!define GROUPNAME "Promethium"
!define APPNAME "promethium"
!define DESCRIPTION "Official Go implementation of the Promethium Chain"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since promethium is installed global
